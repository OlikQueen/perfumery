export function choiceCity(){
    ...
    const citys = [
        { name: "Москва", "subdomain": "msk"},
        { name: "Санкт-Петербург", "subdomain": "spb"},
        { name: "Калуга", "subdomain": "kaluga"},
        { name: "Новосибирск", "subdomain": "novosibirsk"},
        { name: "Владикавказ", "subdomain": "vladikavkaz"},
        { name: "Казань", "subdomain": "kazan"},
    ];
